...
function toChat(type: 'ai' | 'writing') {
  Taro.navigateTo({
    url: `/pages/assistant/chat?type=${type}`,
  });
}
</script>
...
<template>
  <div class="cp-portal-ai">
    <nut-cell @click="toChat('ai')" class="cp-portal-ai__item" title="AI导师" sub-title="我是涉猎广泛的AI导师,如果没有其他问题相关的专业导师就来问我吧!" is-link>
      <template #icon>
